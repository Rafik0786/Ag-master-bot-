...
API_ID = int(environ.get('API_ID', '24897616'))
API_HASH = environ.get('API_HASH', '61f20724c18a07c1150a4297f3240f05')
BOT_TOKEN = environ.get('BOT_TOKEN', "6338690132:AAF0tffD7sMyeNaRqOfISgs6X6j89hnvdOM")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6626800719').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rafikgouri50:<03iR0bYa6oobky4J>@cluster0.1l89jdp.mongodb.net/?retryWrites=true&w=majority")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001866466593')).split()]
